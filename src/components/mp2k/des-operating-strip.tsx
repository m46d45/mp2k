...
export function DesOperatingStrip({
    ...
    return (
      ...
      >
        ...
        <p className="mt-1 text-sm text-muted leading-relaxed">
          ...
          preset → <strong className="text-fg">Run all</strong>. Angka TH, CT, WIP, FR, dan ū di sini
          akan muncul dengan notasi yang sama di kurva Analitik.
        </p>
      </div>
    );
  }
  ...
  const chips: {
  ...
  }[] = [
    {
      ...
      unit: "job/hari",
      explain:
        "Throughput empiris = jumlah job selesai ÷ waktu simulasi T. Di kurva Little, TH adalah sumbu kiri; di Kingman, TH masuk ke utilisasi ū = (TH·te)/m.",
    },
    {
      key: "ct",
      symbol: "CT",
      ...
      unit: "hari",
      explain:
        "Cycle time rata-rata semua job (kolom, balok, panel, stair). Di Little: CT = WIP/TH. Di Kingman, prediksi CT fokus bottleneck — CT sistem DES biasanya beda karena merata-ratakan multi-moda.",
    },
    {
      key: "wip",
      symbol: "WIP",
      ...
      unit: "job",
      explain:
        "Work-in-process rata-rata (integral WIP sepanjang waktu). Little menguji konsistensi: WIP ≟ TH × CT. Titik (WIP, TH) dan (WIP, CT) dipetakan ke kurva WIP–TH–CT.",
    },
    {
      key: "fr",
      symbol: "FR",
      ...
      unit: "panel",
      explain:
        "Fill rate panel = 1 − (stockout / percobaan ambil stok). Terkait tuas Inventory (buffer, L, CONWIP). Di kurva FR vs inventory, FR empiris dibanding model base-stock ideal.",
    },
    {
      key: "util",
      symbol: "ū",
      ...
      explain:
        "Utilisasi resource tersibuk (bottleneck empiris). Kingman: CT meledak saat ū mendekati 1, diperparah V = (ca²+ce²)/2. Titik (ū, CT/te) di kurva multi-V.",
    },
  ];
      ...
      {variant === "full" ? (
        <div className="mt-3 space-y-3 border-t border-border pt-3">
          ...
          <ol className="list-decimal space-y-2 pl-4 text-xs text-muted leading-relaxed">
            ...
            <li>
              <strong className="text-fg">Little</strong> mengikat tiga metrik:{