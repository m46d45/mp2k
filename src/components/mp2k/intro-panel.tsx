    ...
    <div className="space-y-6">
      <div className="max-w-2xl">
        ...
        <p className="mt-2 text-sm text-muted leading-relaxed">
          Satu kurva, dua–tiga if–then, baru rumus. Ramalkan arah sebelum menekan tombol.
          Belum ada denah — itu putaran berikutnya.
        </p>
      </div>
      ...
      {allFormulas ? (
        ...
        <p className="text-xs text-faint">
          Setelah ketiga rumus terbuka, jembatan ke kasus muncul di sini.
        </p>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-4 rounded-[var(--radius-xl)] border border-border bg-surface p-5">
      ...
      {ready ? (
        ...
        <p className="text-xs text-faint">Rumus terbuka setelah ketiga if–then ditekan.</p>
      )}
    </div>
  );
}
