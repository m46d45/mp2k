  ...
  return (
    <div className="space-y-3">
      <p className="rounded-[var(--radius-sm)] border border-border bg-elevated/60 px-3 py-2 text-sm text-muted leading-relaxed">
        ...
        Garis ungu = CONWIP. Titik oranye = DES empiris.
        Envelope TH/CT batas vs aktual = <strong className="text-fg">absolute benchmarking</strong>
        (kinerja vs batas teoritis sistem sendiri, bukan rata-rata industri).{note ? ` ${note}` : ""}
      </p>
      ...
      <p className="text-xs text-muted leading-relaxed">
        <strong className="text-fg">Control</strong>: CONWIP membatasi WIP di DES. Absolute benchmark =
        posisi titik empiris relatif envelope teoritis (W0, Wopt, TH/CT batas). Ubah CONWIP di tuas
        Inventory Simulasi lalu hitung ulang.
      </p>
    </div>
  );
}
